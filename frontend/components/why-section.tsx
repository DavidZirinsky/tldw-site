...
const WhySection = () => {
  ...
  return (
    <section id="why-section" className="py-20 px-4 bg-gradient-to-br from-youtube-red-light/30 to-black relative z-10">
        ...
        <div className="mt-16 text-center">
          <Card className="p-8 bg-gradient-to-r from-youtube-red/5 to-youtube-red-light/20 border-youtube-red/20">
            <CardContent className="p-0">
              <h3 className="text-2xl font-bold mb-4 text-youtube-red">Ready to reclaim your time?</h3>
              <p className="text-lg text-gray-400">
                Join thousands of users who are already saving hours every week by getting straight to the valuable
                content.
              </p>
            </CardContent>
          </Card>
